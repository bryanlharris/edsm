...
def validate_settings(dbutils):
    ...
    # Check that all json settings files have the minimum required keys before proceeding
    ...
    write_key_requirements = {
        "functions.write.stream_upsert_table": ["business_key", "surrogate_key", "upsert_function"],
        "functions.write.batch_upsert_scd2": ["business_key", "surrogate_key", "upsert_function"],

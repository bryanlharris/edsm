...
class DummySpark:
    ...
    def table(self, name):
        ...
        return TableDF(self.tables.get(name, []))
...
class QualityTests(unittest.TestCase):
    ...
    def test_registers_custom_functions(self):
        ...
        class DummyEngine:
            ...
            def apply_checks_by_metadata_and_split(
                self, df_in, checks, custom_check_functions=None
            ):
        ...
        modules = {
            ...
            "databricks.labs.dqx.engine": types.ModuleType(
    ...
    def test_create_dqx_bad_records_table_streaming(self):
        ...
        with unittest.mock.patch.object(
            quality, "apply_dqx_checks", return_value=(df, bad)
        ), unittest.mock.patch.object(
            quality.uuid, "uuid4"
        ) as mock_uuid, unittest.mock.patch.object(
            quality.shutil, "rmtree"
        ) as mock_rm:
            mock_uuid.return_value.hex = "abcd"
